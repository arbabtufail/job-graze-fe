...
import { User, GraduationCap, FileText, Award, ChevronRight } from 'lucide-react'
...
export default function EditTalentPage() {
  ...
  useEffect(() => {
    // Fetch talent data based on the ID
    ...
    const fetchTalent = async () => {
      ...
      const response = await new Promise(resolve => setTimeout(() => resolve({
        ...
        Eligibility: true,
        EducationExperience: {
          EducationDegree: "Bachelor of Science in Nursing",
          Year: "2018",
          SchoolUniversityName: "University of Florida",
          JobExperience: [
            {
              JobTitle: "Registered Nurse",
              RolesResponsibilities: "ICU Care",
        ...
        ProfileDetails: {
          ProfileHeadline: "Experienced ICU Nurse",
          BackgroundSummary: "Dedicated nurse with 3+ years of experience in intensive care.",
        ...
        ProfessionalLicense: {
          ...
          LicenseEffectiveDate: "2018-06-01",
          LicenseExpirationDate: "2024-05-31"
        },
        Certifications: {
          NCLEXRN: "Passed",
          EURN: "N/A",
          LanguageExam: "English"
        }
      }), 1000))
      setTalent(response)
    }
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    console.log('Form submitted:', talent)
    // Redirect back to talent profiles page
    router.push('/talent-profiles')
  }
      ...
      <div className="flex-1 flex flex-col md:pl-64">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-background p-6">
          <div className="container mx-auto max-w-6xl">
            <h1 className="text-3xl font-bold mb-6 text-[#004E64]">Edit Talent Profile</h1>
              ...
              {sections.map((section) => (
                <Card
                  ...
                  className={`audit-tile relative overflow-hidden rounded-lg cursor-pointer ${
                    selectedSection === section.id ? 'ring-4 ring-[#F2994A]' : ''
                  }`}
                  ...
                  if (section.id === selectedSection) {
                    ...
                    return (
                      <div key={section.id}>
                        ...
                        <FormComponent 
                          data={talent} 
                          onUpdate={(updatedData: any) => setTalent({ ...talent, ...updatedData })}
                        />
                      </div>
                    )
                  }
