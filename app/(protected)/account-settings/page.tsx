...
export default function AccountSettingsPage() {
  ...
  const active = search.get('tab') || 'personal';
    ...
    try {
      ...
      json.map((item: any) => {
        item.Name == 'given_name'
          ? personalInfoForm.setValue('firstName', item.Value)
          : item.Name == 'family_name'
          ? personalInfoForm.setValue('lastName', item.Value)
          : item.Name == 'email'
          ? personalInfoForm.setValue('email', item.Value)
          : item.Name == 'phone_number'
          ? personalInfoForm.setValue('phone', item.Value)
          : item.Name == 'custom:bio'
          ? personalInfoForm.setValue('bio', item.Value)
          : null;
      });
    } catch (error) {
      toast({
