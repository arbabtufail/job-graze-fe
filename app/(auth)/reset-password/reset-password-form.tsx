...
export function ResetPasswordForm() {
  ...
  const validatePassword = (password: string) => {
    ...
    // Update state with calculated strength and errors
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/auth/confirm-forget-password', {
        method: 'POST',
  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6'>
      <div className='space-y-2'>
        <Label htmlFor='resetCode' className='text-[#4D4D4D]'>
          Reset Code
        </Label>
      ...
      <div className='space-y-2'>
        <Label htmlFor='newPassword' className='text-[#4D4D4D]'>
          New Password
        </Label>
      ...
      <div className='space-y-2'>
        <Label htmlFor='confirmPassword' className='text-[#4D4D4D]'>
      ...
      <Button
        type='submit'
        disabled={
          isLoading || !passwordStrength || !passwordsMatch || !resetCode
        }
